...
def main():
    ...
    h.initRandom([
        neo.IODesc((2, 4, sensorRes), neo.none, 2, 1, 32), # Priop
        neo.IODesc((2, 3, sensorRes), neo.none, 1, 1, 32), # IMU
        neo.IODesc((4, 4, motorRes), neo.action, 2, 1, 32) # Motor control
        ], lds)
    ...
    while True:
        try:
            ...
            controller.step(pad_y, 0.0, frametime)
